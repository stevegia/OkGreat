...
<head>
  ...
  <link rel="stylesheet" href="../css/admin/makeAppointments.css">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li id="makeAppointments"><a href="makeAppointments.jsp">Make Appointments <span class="sr-only">(current)</span> </a></li>
