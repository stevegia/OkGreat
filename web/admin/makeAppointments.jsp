...
<div class="makeAppointmentsContent">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-2">Seat Type: </div>
      <div class="col-md-3">
        <div class="checkbox-inline">
          <label><input type="checkbox" value="">Set Aside Seat</label>
        </div>
        <div class="checkbox-inline">
          <label><input type="checkbox" value="">Regular Seat</label>
        </div>
      </div>
    </div>
    Student Net Id
    <input type="text" class="form-control" placeholder="Student Netid" aria-describedby="basic-addon2">
