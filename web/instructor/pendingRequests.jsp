...
<div class="pendingRequestsHeader">Pending Requests</div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li id ="pendingRequests"><a href="pendingRequests.jsp">Pending Requests <span class="sr-only">(current)</span></a></li>
